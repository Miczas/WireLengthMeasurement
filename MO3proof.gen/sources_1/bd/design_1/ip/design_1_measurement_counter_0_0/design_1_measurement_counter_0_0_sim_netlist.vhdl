...
--               c:/Xilinx/Fontys/projects/MO3proof/MO3proof.gen/sources_1/bd/design_1/ip/design_1_measurement_counter_0_0/design_1_measurement_counter_0_0_sim_netlist.vhdl
...
entity design_1_measurement_counter_0_0_measurement_counter is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_measurement_counter_0_0_measurement_counter : entity is "measurement_counter";
end design_1_measurement_counter_0_0_measurement_counter;

architecture STRUCTURE of design_1_measurement_counter_0_0_measurement_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_measurement_counter_0_0 is
  port (
    val : out STD_LOGIC_VECTOR ( 31 downto 0 );
    clear : in STD_LOGIC;
    count : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_measurement_counter_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_measurement_counter_0_0 : entity is "design_1_measurement_counter_0_0,measurement_counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_measurement_counter_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_measurement_counter_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_measurement_counter_0_0 : entity is "measurement_counter,Vivado 2022.1";
end design_1_measurement_counter_0_0;

architecture STRUCTURE of design_1_measurement_counter_0_0 is
...
begin
U0: entity work.design_1_measurement_counter_0_0_measurement_counter
     port map (
      clear => clear,
      clk => clk,
      count => count,
